...
namespace TafraKit
{
    public class MaxAdsSocketSettings : SettingsModule
    {
        ...
        public override string Name => "Monetization/Tafra Ads/MAX Ads Socket";
        public override string Description => "Displaying ads through AppLovin MAX SDK.";
