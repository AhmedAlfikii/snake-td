...
namespace TafraKit
{
    public class OnScreenJoystick : OnScreenControl
    {
        ...
        [Tooltip("Disable this if you're using Unity's input system itself. Enable it if you will directly listen to events sent by this joystick.")]
        [SerializeField] private bool invokeValueEvents = true;
        ...
        protected override string controlPathInternal { get => inputControlPath; set => inputControlPath = value; }
        #endregion
        ...
        void Update()
        {
            ...
            if (beingControlled)
            {
                ...
                SendValueToControl((Vector2)dir);
