...
{
    [CustomNodeEditor(typeof(ActiveAbilityNode))]
    public class ActiveAbilityNodeEditor : AbilityNodeEditor
    {
        public ActiveAbilityNodeEditor(BTNode btNode) : base(btNode)
        {
