...
namespace TafraKit.Internal.CharacterControls
{
    ...
    public class AbilityRepeatNode : AbilityDecoratorNode
    {
        ...
        public AbilityRepeatNode(AbilityRepeatNode other) : base(other)
        {
            repeatRule = other.repeatRule;
            failIfChildFailed = other.failIfChildFailed;
        }
        ...
        protected override void OnInitialize()
        {
            ...
            //repeatConditions.SetAgent(agent);

            //executionsCount.SetBlackboardCollection(agent.BlackboardCollection);
        }
        ...
        {
            AbilityRepeatNode clonedNode = new AbilityRepeatNode(this);
