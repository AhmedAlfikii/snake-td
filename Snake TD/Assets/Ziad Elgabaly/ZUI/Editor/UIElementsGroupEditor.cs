...
namespace ZUI
{
    ...
    public class UIElementsGroupEditor : Editor
    {
        ...
        private UIElementsGroup myElementsGroup;
        ...
        void OnEnable()
        {
            ...
            myElementsGroup = target as UIElementsGroup;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if(Application.isPlaying)
            {
                ...
                {
                    myElementsGroup.ChangeVisibility(true);
                }
                if(GUILayout.Button("Hide", GUILayout.Height(30)))
                {
                    myElementsGroup.ChangeVisibility(false);
                }
            }
            #endregion
