...
namespace ZUI
{
    ...
    public class UIAnimation : MonoBehaviour
    {
        ...
        public class AnimationSection
        {
            ...
            public ZUIEquations.MotionType Type = ZUIEquations.MotionType.EaseOut;
            ...
            public AnimationSection(bool use, Vector3 wantedVec)
            {
                ...
                Type = ZUIEquations.MotionType.EaseOut;
                Duration = -1;
            }
        ...
        void Awake()
        {
            ...
            myUIElement.OnShow.AddListener(() =>
            { 
                if (playOnShow)
                    Play();
            });
            myUIElement.OnHide.AddListener(() => 
            { 
                Stop();
            });
        }
        ...
        public void SetPlayOnShow(bool play)
        {
            playOnShow = play;
        }
        ...
        {
            if (myUIElement.UseUnscaledTime)
                yield return new WaitForSecondsRealtime(StartAnimationAfter);
            else
            ...
            for (int i = 0; i < AnimationFrames.Count; i++)
            {
                ...
                if (myUIElement.UseUnscaledTime)
                    yield return new WaitForSecondsRealtime(frame.StartAfter);
                else
                ...
                if (myUIElement.UseUnscaledTime)
                    yield return new WaitForSecondsRealtime(frame.Duration);
                else
